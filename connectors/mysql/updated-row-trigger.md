---
title: Workato connectors - MySQL new/updated row triggers
...
![New/updated row trigger](/assets/images/mysql/new-updated-row-trigger.png)
...
![New/updated batch of rows trigger](/assets/images/mysql/new-updated-batch-of-rows-trigger.png)
