---
title: Workato connectors - MySQL new row triggers
...
![New row trigger](/assets/images/mysql/new-row-trigger.png)
*New row trigger*
...
![New batch of rows trigger](/assets/images/mysql/new-batch-of-rows-trigger.png)
