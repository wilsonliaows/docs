...
<table class="unchanged rich-diff-level-one">
  ...
  <tbody>
    <tr>
      <td>File</td>
      <td>
        Select the file to move. This can be done either by selecting a file from the pick list, or toggling the input field to text mode and providing the folder path.<br>
