...
Through these triggers, you can easily link other applications to get more benefits from QuickBooks Online. For instance, you could build a recipe that a trigger on a specificed interval can get details of specific items from QuickBooks Online.
