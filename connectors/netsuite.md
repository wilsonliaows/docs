...
## Create standard records in bulk and create custom records in bulk actions

These actions allow you to create in bulk standard records or custom records.
...
### Output
The followings are all output data pills of this action:
...
## Update standard records in bulk and update custom records in bulk actions

These actions allow you to update in bulk standard records or custom records in NetSuite.
...
## Upsert standard records in bulk and Upsert custom records in bulk actions

These actions allow you to upsert in bulk standard records or custom records in NetSuite.
