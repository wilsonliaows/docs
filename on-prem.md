...
* To upgrade your OPA, you can download a new installer and install over your current agent - your OPA will be updated.
...
* Set the location of the new agent to be the location of your old OPA (`<INSTALL_HOME>`). Finish the installation.
