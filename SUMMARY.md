...
* [Building recipes](recipes/building-recipes.md)
  ...
  * [Data pills and mapping](recipes/data-pills-and-mapping.md)
    ...
    * [Group data mapping](recipes/group-data-mapping.md)
    * [Data transformation](recipes/data-pills-and-mapping.md#data-transformation)
  * [Recipe building best practices](recipes/best-practices-building.md)
...
* [Workbot for Slack](workbot/workbot.md)
  ...
  * [Workbot actions](workbot/workbot-actions.md)
    * [Post command reply](workbot/workbot-actions.md#post-command-reply)
...
* [Connectors](connectors.md)
  * [Active Directory](connectors/active_directory.md)
    * [Connection setup](connectors/active_directory.md#how-to-connect-to-active_directory-on-workato)
    * [Search entries](connectors/active_directory/search_entries.md)
    * [Add entry](connectors/active_directory/add_entry.md)
    * [Update entry](connectors/active_directory/update_entry.md)
    * [New entry trigger](connectors/active_directory/new_entry_trigger.md)
    * [New/updated entry trigger](connectors/active_directory/updated_entry_trigger.md)
    * [Scheduled entry search trigger](connectors/active_directory/scheduled_trigger.md)
  * [ADP Workforce Now](connectors/adp_workforce.md)
    * [Connection setup](connectors/adp_workforce.md#how-to-connect-to-adp_workforce-now-on-workato)
    * [Scheduled worker search](connectors/adp_workforce/scheduled_worker_search.md)
  ...
  * [Box](connectors/box.md)
    ...
    * [New file trigger](connectors/box/trigger-new-file.md)
    * [New CSV file trigger](connectors/box/trigger-new-csv.md)
    * [Search files action](connectors/box/action-search-files.md)
    * [Download file action](connectors/box/action-download-file.md)
    * [Upload file action](connectors/box/action-upload-file-contents.md)
  ...
  * [Dropbox](connectors/dropbox.md)
    * [Connection setup](connectors/dropbox.md)
    * [New/updated file trigger](connectors/dropbox/trigger-new-updated-file.md)
    * [New/updated CSV trigger](connectors/dropbox/trigger-new-updated-csv.md)
    * [Search files action](connectors/dropbox/action-search-files.md)
  ...
  * [Google Drive](connectors/google-drive.md)
    ...
    * [Create folder action](connectors/google-drive/action-create-folder.md)
    * [Download file action](connectors/google-drive/action-download-file.md)
    * [Rename/move file or folder action](connectors/google-drive/action-rename-file.md)
    * [Search files or folders action](connectors/google-drive/action-search-files.md)
    * [Upload file action](connectors/google-drive/action-upload-file.md)
  * [Google Sheets](connectors/google-sheets.md)
    ...
    * [Update row using row ID action](connectors/google-sheets/action-update-row.md)
  ...
  * [Google Translate](connectors/google-translate.md)
    * [Connection setup](connectors/google-tranlate.md#how-to-connect-to-google-translate-on-workato)
    * [Translate text action](connectors/google-translate/action-translate-text.md)
  ...
  * [JDBC](connectors/jdbc.md)
    ...
    * [Run custom SQL action](connectors/jdbc/run_sql.md)
  ...
  * [Jira](connectors/jira.md)
    ...
    * [Create issue action](/connectors/jira/actions.md#create-issue)
    * [Get issue action](/connectors/jira/actions.md#get-issue)
    * [Search issues action](/connectors/jira/actions.md#search-issues)
    * [Update issue action](/connectors/jira/actions.md#update-issue)
    * [Search assignable user action](/connectors/jira/actions.md#search-assignable-user)
    * [Assign user to issue action](/connectors/jira/actions.md#assign-user-to-issue)
    * [Download attachment action](/connectors/jira/actions.md#download-attachment)
    * [Upload attachment action](/connectors/jira/actions.md#upload-attachment)
    * [Create comment action](/connectors/jira/actions.md#create-comment)
    * [Get issue comments action](/connectors/jira/actions.md#get-issue-comments)
    * [Update comment action](/connectors/jira/actions.md#update-comment)
    * [Create user action](/connectors/jira/actions.md#create-user)
    * [Get user details action](/connectors/jira/actions.md#get-user-details)
  ...
  * [MySQL](connectors/mysql.md)
    ...
    * [Run custom SQL action](connectors/mysql/run_sql.md)
  ...
  * [NetSuite](connectors/netsuite.md)
    ...
    * [Create records in bulk action](connectors/netsuite.md#create-standard-records-in-bulk-and-create-custom-records-in-bulk-actions)
    ...
    * [Update records in bulk action](connectors/netsuite.md#update-standard-records-in-bulk-and-update-custom-records-in-bulk-actions)
    * [Upsert records in bulk action](connectors/netsuite.md#upsert-standard-records-in-bulk-and-upsert-custom-records-in-bulk-actions)
  * [On-prem command-line scripts](connectors/on-prem-command-line-scripts.md)
    * [Setup and connection](connectors/on-prem-command-line-scripts.md#setup-and-connection)
    * [Execute command-line script action](connectors/on-prem-command-line-scripts.md#execute-command-line-script-action)
  * [On-prem files](connectors/on-prem-files.md)
    * [Connection setup](connectors/on-prem-files.md#how-to-connect-to-on-prem-files)
    * [New file trigger](connectors/on-prem-files/trigger-new-file.md)
    * [New CSV file trigger](connectors/on-prem-files/trigger-new-csv.md)
    * [New CSV line trigger](connectors/on-prem-files/new-line-trigger.md)
    * [New CSV lines trigger](connectors/on-prem-files/new-lines-trigger.md)
    * [Upload file action](connectors/on-prem-files/upload-file-action.md)
    * [Download file action](connectors/on-prem-files/download-file-action.md)
    * [Move file action](connectors/on-prem-files/move-file-action.md)
    * [Rename file action](connectors/on-prem-files/rename-file-action.md)
    * [List files in folder action](connectors/on-prem-files/list-files-action.md)
    * [Append CSV line action](connectors/on-prem-files/append-csv-line-action.md)
  ...
  * [PostgreSQL](connectors/postgresql.md)
    ...
    * [Run custom SQL action](connectors/postgresql/run_sql.md)
  ...
  * [PubSub by Workato](connectors/pubsub.md)
    ...
    * [New message trigger](connectors/pubsub.md#using-the-new-message-trigger)
    * [Publish message action](connectors/pubsub.md#using-the-publish-message-action)
  * [Quick Base](connectors/quick-base.md)
    * [Connection setup](connectors/quick-base.md#how-to-connect-to-quick-base-on-workato)
    * [Bulk import from CSV action](connectors/quick-base/action-import-csv.md)
  ...
  * [SAP](connectors/sap.md)
    * [Connection setup](connectors/sap.md)
  ...
  * [Slack](connectors/slack.md)
    ...
    * [Actions](/connectors/slack/actions.md)
      * [Post message actions](/connectors/slack/actions.md#post-message-actions)
      * [Respond to button click actions](/connectors/slack/actions.md#respond-to-button-click-actions)
      * [Invite user to channel actions](/connectors/slack/actions.md#invite-user-to-channel-actions)
      * [Invite user to group actions](/connectors/slack/actions.md#invite-user-to-group-actions)
      * [Archive channel actions](/connectors/slack/actions.md#archive-channel-actions)
      * [Unarchive channel actions](/connectors/slack/actions.md#unarchive-channel-actions)
      * [Create channel actions](/connectors/slack/actions.md#create-channel-actions)
      * [Set channel purpose actions](/connectors/slack/actions.md#set-channel-purpose-actions)
      * [Set channel topic actions](/connectors/slack/actions.md#set-channel-topic-actions)
    * [Slack vs Workbot](workbot/workbot.md#slack-connector-vs-workbot-for-slack-connector)
...
* [Developing connectors](developing-connectors.md)
  ...
  * [HTTP connector V2](developing-connectors/http-v2.md)
    ...
    * [Example: Eventbrite OAuth2 connection](developing-connectors/http-v2.md#example---connecting-to-eventbrite-via-oauth2)
    * [Webhook triggers](developing-connectors/http.md#building-webhook-triggers)
    * [Example: New Eventbrite order](developing-connectors/http.md#example---building-a-new-order-trigger-in-eventbrite)
    * [HTTP actions](developing-connectors/http-v2.md#building-a-workato-action-example---create-venue-in-eventbrite)
  * [HTTP connector V1 (deprecated)](developing-connectors/http.md)
    * [OAuth2 connection setup (deprecated)](developing-connectors/http.md#set-up-your-oauth2-connection)
    * [Example: Eventbrite OAuth2](developing-connectors/http.md#example---connecting-to-eventbrite-via-oauth2)
    * [Non-OAuth2 connection setup (deprecated)](developing-connectors/http.md#set-up-your-non-oauth2-connection)
    * [Example: Jira basic auth](developing-connectors/http.md#example---connecting-to-jira-via-basic-authentication-and-testing-the-connection-via-a-get-action)
    * [Webhook triggers](developing-connectors/http.md#building-webhook-triggers)
    * [Example: New Eventbrite order](developing-connectors/http.md#example---building-a-new-order-trigger-in-eventbrite)
    * [HTTP actions (deprecated)](developing-connectors/http.md#building-your-rest-request-action)
