...
![Selecting the custom action](/assets/images/developing-connectors/custom-action-selection.png)
...
![App scopes available for the custom action](/assets/images/developing-connectors/app-scopes.png)
...
![Scope error returned by the API when call is made](/assets/images/developing-connectors/custom-action-scope-error-output.png)
...
![Select the Slack custom action](/assets/images/developing-connectors/select-slack-custom-action.png)
...
![Slack's API documentation for list channels](/assets/images/developing-connectors/slack-list-channels-http-method-docs.png)
*Slack's API documentation for list channels*

Once selected, relevant fields show up in the action for you to fill.

![Additional fields show up when you select HTTP method](/assets/images/developing-connectors/select-http-method.gif)
...
![Adding URL endpoint for list channels](/assets/images/developing-connectors/add-url-endpoint.png)
...
![Slack API documentation on arguments for list channel endpoint](/assets/images/developing-connectors/slack-list-channels-http-method-docs.png)
...
![Adding URL params for the custom action](/assets/images/developing-connectors/add-custom-action-params.gif)
...
![Filling in values for params](/assets/images/developing-connectors/fill-in-param-values.gif)
...
![Slack API documentation for list channels response](/assets/images/developing-connectors/slack-docs-list-channels-api-response.png)
...
![Generate output datatree in Workato with JSON response sample in API documentation](/assets/images/developing-connectors/generate-output-schema.gif)
...
![Generated output datatree in Workato](/assets/images/developing-connectors/generated-output-datatree.gif)
...
![Completed Slack custom action to list channels](/assets/images/developing-connectors/full-slack-custom-action.png)
...
![Job history - input data](/assets/images/developing-connectors/list-channels-action-input.png)
...
![Job history - output showing channel data returned](/assets/images/developing-connectors/list-channels-action-input.png)
